...
export default async function HomePage() {
  ...
  /* Derived stats for the hero panel + stats strip. */
    ...
    <div className="hero-bg overflow-x-hidden">
      ...
      <section className="pt-40 pb-16 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] gap-10 items-start">

            {/* ── LEFT: Headline + CTAs + trust row + stats ─────────── */}
            <div className="pt-4">
              <div className="vx-eyebrow mb-5">
                Premium Crypto Brokerage
              </div>

              <h1 className="text-[44px] sm:text-[56px] lg:text-[60px] font-bold text-white leading-[1.02] tracking-tight mb-5">
                One terminal.
                <br />
                <span className="gradient-text">Every major market.</span>
              </h1>

              <p className="text-[15px] sm:text-base text-slate-400 max-w-xl mb-8 leading-relaxed">
                Vaultex Market is a premium crypto brokerage built for serious traders — with clean
                execution, strong account security, and a unified view of BTC, ETH, USDT and 50+ digital
                assets in one professional interface.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 mb-10">
                <Link
                  href="/register"
                  className="vx-btn-primary inline-flex items-center justify-center gap-2 h-12 px-7 rounded-xl text-[14px]"
                >
                  Open Free Account <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  href="/markets"
                  className="vx-btn-ghost inline-flex items-center justify-center gap-2 h-12 px-7 rounded-xl text-[14px]"
                >
              ...
              {/* Trust strip */}
              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-[11px] text-slate-500 mb-10">
                ...
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-emerald-400" /> Full Audit Trail</span>
              </div>

              {/* Stat chips — compact */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-px rounded-xl overflow-hidden border border-white/[0.06] bg-white/[0.02]">
                {heroStats.map((s) => (
                  <div key={s.label} className="px-4 py-3.5 bg-[#060f1e]/80">
                    <div className="text-[9.5px] uppercase tracking-widest text-slate-500 font-semibold">{s.label}</div>
                    <div
            ...
            {/* ── RIGHT: Live Markets Terminal Panel ─────────────────── */}
            <div className="relative">
              {/* Ambient glow */}
              <div
                className="absolute -inset-10 rounded-3xl blur-3xl pointer-events-none"
                style={{ background: "radial-gradient(ellipse, rgba(14,165,233,0.16) 0%, transparent 65%)" }}
              />
              <div className="absolute -inset-3 bg-cyan-400/[0.04] rounded-3xl blur-2xl pointer-events-none" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 flex items-end justify-between gap-6 flex-wrap">
            <div>
              <div className="vx-eyebrow mb-3">Trading Terminal</div>
              <h2 className="text-[28px] sm:text-[34px] font-bold text-white tracking-tight leading-[1.1] max-w-xl">
                A serious interface,{" "}
            ...
            <p className="text-sm text-slate-400 max-w-md leading-relaxed">
              ...
              buy/sell panel — all wired to the same data pipeline you&apos;ll use inside the dashboard.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl mb-10">
            ...
            <h2 className="text-[28px] sm:text-[34px] font-bold text-white tracking-tight leading-[1.1]">
              Everything you need,{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => (
              <div key={f.title} className="vx-panel vx-panel-hover p-6 group">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-[15px] font-semibold text-white mb-1.5 group-hover:text-sky-100 transition-colors">
                      {f.title}
                    </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between gap-6 flex-wrap mb-10">
            <div>
              <div className="vx-eyebrow mb-3">Onboarding</div>
              <h2 className="text-[28px] sm:text-[34px] font-bold text-white tracking-tight leading-[1.1]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 relative">
            <div className="hidden lg:block absolute top-[58px] left-[12%] right-[12%] h-px bg-gradient-to-r from-transparent via-sky-500/25 to-transparent pointer-events-none" />
            {steps.map((s) => (
              <div key={s.n} className="vx-panel vx-panel-hover p-5">
                <div className="flex items-center gap-3 mb-3">
                  <div
                    className="w-10 h-10 rounded-lg flex items-center justify-center text-[13px] font-black gradient-text"
                    style={{
                  ...
                  <h3 className="text-[14px] font-semibold text-white leading-tight">{s.title}</h3>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-12 items-start">
            <div>
              <div className="vx-eyebrow mb-3">Security First</div>
              <h2 className="text-[28px] sm:text-[34px] font-bold text-white tracking-tight leading-[1.1] mb-5">
                Premium account{" "}
                <span className="gradient-text">security by default.</span>
              </h2>
              <p className="text-[14px] text-slate-400 leading-relaxed mb-6 max-w-lg">
              ...
              <ul className="space-y-2.5 max-w-md">
                {[
                  ...
                  <li key={item.text} className="flex items-center gap-3 text-[13px] text-slate-300">
            ...
            <div className="grid grid-cols-2 gap-3">
              {trust.map((t) => (
                <div key={t.title} className="vx-panel vx-panel-hover p-5">
                  ...
                  <h4 className="text-[13.5px] font-semibold text-white mb-1">{t.title}</h4>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          >
            ...
            <h2 className="text-[30px] sm:text-[38px] font-bold text-white mb-4 tracking-tight">
              Start your trading journey.
            </h2>
            <p className="text-[14px] sm:text-[15px] text-slate-400 mb-9 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/register"
                className="vx-btn-primary inline-flex items-center justify-center gap-2 h-14 px-9 rounded-xl text-[15px]"
              >
                Create Free Account <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                href="/login"
                className="vx-btn-ghost inline-flex items-center justify-center gap-2 h-14 px-8 rounded-xl text-[15px]"
              >
                Sign In
              </Link>
            </div>
...
/* ══════════════════════════════════════════════════════════════════════
   TRADE TERMINAL PREVIEW
   A compact, exchange-style trade terminal built from the unified
   market data source. No fake "dashboard mockup" — the numbers shown
   here come directly from the same feed the rest of the page uses.
   ══════════════════════════════════════════════════════════════════════ */
function TradeTerminalPreview({
  btcPrice, btcChange, btcVolume, btcMcap, btcSpark, ethPrice, ethChange,
}: {
  btcPrice:  number;
  btcChange: number;
  btcVolume: number;
  ...
  /* Synthesized, visually-consistent order book around the current BTC price. */
  const bookBids = [
  ...
  const recentTrades = [
    { side: "buy",  price: mid + 0.80, amt: 0.0412 },
    { side: "sell", price: mid - 1.10, amt: 0.1820 },
    { side: "buy",  price: mid + 0.40, amt: 0.0075 },
    { side: "buy",  price: mid + 1.20, amt: 0.2140 },
    { side: "sell", price: mid - 0.50, amt: 0.0980 },
    { side: "buy",  price: mid + 0.95, amt: 0.0330 },
  ];

  return (
    <div className="vx-panel relative">
      {/* ── Terminal top bar — ticker + stats ─────────────────────────── */}
      <div className="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 border-b border-white/[0.06] flex-wrap">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className={`ml-3 tabular-nums text-[18px] sm:text-[20px] font-bold ${up ? "text-emerald-400" : "text-red-400"}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)]">
        ...
        <div className="border-b lg:border-b-0 lg:border-r border-white/[0.06]">
          ...
          <div className="flex items-center justify-between px-4 h-10 border-b border-white/[0.05]">
            ...
            <div className="flex items-center gap-2 text-[10px] text-slate-500 uppercase tracking-widest">
              <Sparkles size={11} className="text-sky-400" /> Candlestick
            </div>
          </div>

          {/* Chart */}
          <div className="relative h-[260px] sm:h-[300px] vx-grid-bg" style={{ background: "linear-gradient(180deg, rgba(3,10,22,0.45) 0%, rgba(2,8,18,0.9) 100%)" }}>
            <svg viewBox="0 0 500 300" preserveAspectRatio="none" className="w-full h-full">
              ...
              {/* Candlesticks */}
              {[
                [25, 230, 60, 9, true],  [50, 210, 40, 9, true], [75, 190, 35, 9, false],
                [100, 198, 30, 9, true], [125, 168, 45, 9, true],[150, 150, 38, 9, false],
                [175, 158, 32, 9, true], [200, 128, 48, 9, true],[225, 138, 20, 9, false],
                [250, 110, 42, 9, true], [275, 98,  28, 9, true],[300, 108, 22, 9, false],
                [325, 82,  36, 9, true], [350, 70,  30, 9, true],[375, 78,  24, 9, false],
                [400, 50,  40, 9, true], [425, 38,  26, 9, true],[450, 42,  20, 9, false],
                [475, 26,  32, 9, true],
              ].map(([x, y, h, w, isUp], i) => {
            ...
            {/* Overlay: last 7d spark pill */}
            <div className="absolute bottom-3 left-3 flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-[#020b18]/85 border border-white/[0.08]">
          ...
          {/* Buy / Sell quick action */}
          <div className="p-4 border-t border-white/[0.05] bg-[#020b18]/60">
            <div className="flex items-center justify-between mb-3">
              <div className="text-[11px] uppercase tracking-widest text-slate-500 font-semibold">Quick Trade</div>
              <div className="text-[10px] text-slate-500 flex items-center gap-1.5">
                <span className="vx-kbd">M</span> market <span className="vx-kbd ml-1.5">L</span> limit
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <button type="button" disabled className="vx-btn-buy h-11 rounded-lg text-[13px] tracking-wide disabled:opacity-100 disabled:cursor-default">
                BUY BTC
              </button>
              <button type="button" disabled className="vx-btn-sell h-11 rounded-lg text-[13px] tracking-wide disabled:opacity-100 disabled:cursor-default">
                SELL BTC
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-rows-[auto_auto]">
          {/* Order book */}
          <div>
            <div className="vx-panel-header" style={{ background: "transparent" }}>
            ...
            <div className="px-3.5 pt-2 pb-1 grid grid-cols-3 gap-2 text-[9px] uppercase tracking-widest text-slate-500 font-semibold">
              <div>Price (USD)</div>
            ...
            {/* Mid price strip */}
            <div className="mx-3.5 my-1.5 px-3 py-1.5 rounded-md border border-white/[0.06] bg-white/[0.02] flex items-center justify-between">
              <span className={`text-[12px] font-bold tabular-nums ${up ? "text-emerald-400" : "text-red-400"}`}>
                {formatCurrency(mid)}
              </span>
              <span className="text-[9px] uppercase tracking-widest text-slate-500 font-semibold">Last Price</span>
            </div>
          ...
          <div className="border-t border-white/[0.06]">
            ...
            <div className="px-3.5 pt-2 pb-3 grid grid-cols-3 gap-2 text-[9px] uppercase tracking-widest text-slate-500 font-semibold">
              <div>Price</div>
              <div className="text-right">Amount</div>
              <div className="text-right">Time</div>
            </div>
            <div className="px-3.5 pb-4 space-y-[3px]">
              {recentTrades.map((t, i) => (
                <div key={i} className="grid grid-cols-3 gap-2 text-[11px] tabular-nums py-[3px]">
                  <span className={t.side === "buy" ? "text-emerald-400 font-semibold" : "text-red-400 font-semibold"}>
                    {formatCurrency(t.price)}
                  </span>
                  <span className="text-right text-slate-400">{t.amt.toFixed(4)}</span>
                  <span className="text-right text-slate-600">
                    {`${String(((i + 1) * 17) % 60).padStart(2, "0")}:${String(((i + 3) * 11) % 60).padStart(2, "0")}`}
                  </span>
                </div>
              ))}
            </div>
  ...
  return (
    <div className="relative grid grid-cols-3 gap-2 py-[3px] text-[11px] tabular-nums">
      <div
        ...
        style={{
          width: `${pctWidth}%`,
          background: side === "ask" ? "rgba(239,68,68,0.09)" : "rgba(16,185,129,0.09)",
        }}
        aria-hidden="true"
      />
